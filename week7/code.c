...
int main()
{
    ...
    while (1)
    {
        ...
        case 'c':
            ...
            double lowest = daily_readings[0].bloodIron;
            for (int i = 0; i < counter; i++){
        ...
        case 'd':
            ...
            double highest = daily_readings[0].bloodIron;
            for (int i = 0; i < counter; i++){
        ...
        case 'e':
            ...
            printf("please enter the date which you want to know");
            scanf("%s",&month_spe);
